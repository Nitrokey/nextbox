 ...
 */
var getAllChunkIds = function getAllChunkIds(items) {
  return items.reduce(function (agg, item) {
    var itemChunkIds = item.runs.map(function (run) {
      return run === null || run === void 0 ? void 0 : run.chunkId;
    ...
    return itemChunkIds.reduce(function (itemAgg, chunkId) {
      ...
      return [].concat(_toConsumableArray(itemAgg), [chunkId]);
    }, agg);
  }, []);
};

exports.getAllChunkIds = getAllChunkIds;