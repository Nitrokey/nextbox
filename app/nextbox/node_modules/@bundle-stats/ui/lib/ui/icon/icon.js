...
exports.ICONS = ICONS;
var ICON_MAP = (_ICON_MAP = {}, _defineProperty(_ICON_MAP, ICONS.ARROW, ArrowIcon), _defineProperty(_ICON_MAP, ICONS.BRANCH, BranchIcon), _defineProperty(_ICON_MAP, ICONS.CANCEL, CancelIcon), _defineProperty(_ICON_MAP, ICONS.CLOCK, ClockIcon), _defineProperty(_ICON_MAP, ICONS.CLOSE, CloseIcon), _defineProperty(_ICON_MAP, ICONS.COMMIT, CommitIcon), _defineProperty(_ICON_MAP, ICONS.FILTER, FilterIcon), _defineProperty(_ICON_MAP, ICONS.HELP, HelpIcon), _defineProperty(_ICON_MAP, ICONS.MENU, MenuIcon), _defineProperty(_ICON_MAP, ICONS.PACKAGE, PackageIcon), _defineProperty(_ICON_MAP, ICONS.PR, PullRequestIcon), _defineProperty(_ICON_MAP, ICONS.SORT, SortIcon), _defineProperty(_ICON_MAP, ICONS.WARNING, WarningIcon), _ICON_MAP);

var Icon = function Icon(_ref) {
  var className = _ref.className,
      glyph = _ref.glyph,
      Component = _ref.as,
      restProps = _objectWithoutProperties(_ref, ["className", "glyph", "as"]);

  var Svg = typeof glyph === 'string' ? ICON_MAP[glyph] : glyph;
  return /*#__PURE__*/_react["default"].createElement(Component, _extends({
    className: (0, _classnames["default"])(_iconModule["default"].root, className)
...
Icon.propTypes = {
  ...
  glyph: _propTypes["default"].oneOfType([_propTypes["default"].oneOf(Object.values(ICONS)), _propTypes["default"].node]).isRequired,
