...
import { ASSET_ENTRY_TYPE, ASSET_FILE_TYPE, ASSET_FILTERS, COMPONENT, MODULE_CHUNK, MODULE_FILE_TYPE, MODULE_FILTERS, PACKAGE_FILTERS, SECTIONS, } from '../config/component-links';
import I18N from '../i18n';
export const getAssetFileTypeFilters = (value = true) => FILE_TYPES.reduce((agg, fileTypeFilter) => ({
    ...agg,
    [`${ASSET_FILE_TYPE}.${fileTypeFilter}`]: value,
}), {});
export const getAssetEntryTypeFilters = (value = true) => [ASSET_FILTERS.ENTRY, ASSET_FILTERS.INITIAL, ASSET_FILTERS.CHUNK, ASSET_FILTERS.ASSET].reduce((agg, entryTypeFilter) => ({
    ...agg,
    [`${ASSET_ENTRY_TYPE}.${entryTypeFilter}`]: value,
}), {});
export const getModuleChunkFilters = (chunkIds, value) => chunkIds.reduce((agg, chunkId) => ({
    ...agg,
    [`${MODULE_CHUNK}.${chunkId}`]: value,
}), {});
export const getModuleFileTypeFilters = (value = true) => MODULE_SOURCE_FILE_TYPES.reduce((agg, fileType) => ({
    ...agg,
